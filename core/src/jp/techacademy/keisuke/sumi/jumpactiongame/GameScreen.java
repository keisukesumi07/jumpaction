...
public class GameScreen extends ScreenAdapter {
    ...
    Sound sound = Gdx.audio.newSound(Gdx.files.internal("data/sound.mp3"));
    ...
    private void createStage() {
        ...
        Texture enemyTexture = new Texture("s_enemy.png");
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.7f) {
                int etype = mRandom.nextFloat() > 0.3f ? Enemy.Enemy_TYPE_MOVING : Enemy.Enemy_TYPE_STATIC;
